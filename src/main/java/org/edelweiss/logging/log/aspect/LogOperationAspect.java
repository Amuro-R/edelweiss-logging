...
import org.edelweiss.logging.log.annotation.LogOperation;
...
import org.edelweiss.logging.log.context.TemplateHandlerContext;
...
import org.edelweiss.logging.pojo.log.ResultType;
...
public class LogOperationAspect {
    ...
    private LogPO logAfter(Method method, Object[] args, LogOperation logOperationOnMethod, LogOperation logOperationOnClass,
        ...
        ResultType resultType = this.getResultType(methodExecuteResult);
...
//        操作类型非共有
    ...
    private LogPO getLogOperationPO(LogEvaluationContext afterEvaluationContext, ResultType resultType, String content) {
    ...
    private ResultType getResultType(MethodExecuteResult methodExecuteResult) {
